...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
grep -E "^#trg " "/etc/xray/config.json" | cut -d ' ' -f 2-3 | nl -w2 -s '. ' | sort | uniq
echo ""
...
NUMBER_OF_CLIENTS=$(grep -c -E "^#trg " "/etc/xray/config.json")
    ...
    sed -i "/^${user} /d" "/etc/xray/limit/usage-trojan" >/dev/null 2>&1
...
function trialtrojan(){
    ...
    # Add to database
    echo "$user trojan $exp_timestamp" >> /etc/expired-users.db
    ...
    # Add to config.json
    sed -i '/#trojanws$/a\#tr '"$user $exp_display"'\
},{"password": "'""$uuid""'","email": "'""$user""'"' /etc/xray/config.json
    sed -i '/#trojangrpc$/a\#trg '"$user $exp_display"'\
},{"password": "'""$uuid""'","email": "'""$user""'"' /etc/xray/config.json
    ...
    trojanlink4="trojan://${uuid}@${domain}:${tr}?mode=gun&security=tls&type=grpc&serviceName=trojan-grpc&path=trojan-grpc&sni=${domain}#TROJAN_GRPC_${user}"
    ...
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "Link GO   : ${trojanlink2}"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo -e "Link GRPC : ${trojanlink4}"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
