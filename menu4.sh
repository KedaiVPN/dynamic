...
echo -e "${BICyan} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "    ${BICyan}[${BIRed}01${BICyan}]${BIWhite} SSHWS         ${BIRed}||         [${BIRed}06${BICyan}]${BIWhite} RESTORE EXPIRED USER${NC}"
echo -e "    ${BICyan}[${BIRed}02${BICyan}]${BIWhite} VMESS         ${BIRed}||         [${BIRed}07${BICyan}]${BIWhite} USER BANDWIDTH${NC}"
echo -e "    ${BICyan}[${BIRed}03${BICyan}]${BIWhite} VLESS         ${BIRed}||         [${BIRed}08${BICyan}]${BIWhite} RUNNING STATUS${NC}"
echo -e "    ${BICyan}[${BIRed}04${BICyan}]${BIWhite} TROJAN        ${BIRed}||         [${BIRed}09${BICyan}]${BIWhite} BACKUP/RESTORE${NC}"
echo -e "    ${BICyan}[${BIRed}05${BICyan}]${BIWhite} SHADOWSOCK    ${BIRed}||         [${BIRed}10${BICyan}]${BIWhite} FEATURES${NC}"
echo -e "${BICyan} └────────────────────────────────────────────────────────────┘${NC}"
