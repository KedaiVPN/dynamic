...
echo -e "${BICyan} │"                                                                      
echo -e "${BICyan} │  ${IBlue}OS Linux        :  ${BIWhite}$(hostnamectl | grep "Operating System" | cut -d ' ' -f5-)${NC}"  
echo -e "${BICyan} │  ${IBlue}Kernel          :  ${BIWhite}$(uname -r)${NC}"  
echo -e "${BICyan} │  ${IBlue}CPU Name        :  ${BIWhite}$cname${NC}"
echo -e "${BICyan} │  ${IBlue}CPU Info        :  ${BIWhite}$cores Cores @ $freq MHz (${cpu_usage}) ${NC}"
echo -e "${BICyan} │  ${IBlue}Total RAM       :  ${BIWhite}${ram_used}MB / ${total_ram}MB (${ram_usage}%) ${NC}" 
echo -e "${BICyan} │  ${IBlue}System Uptime   :  ${BIWhite}$uptime${NC}"
echo -e "${BICyan} │  ${IBlue}Current Domain  :  ${BIWhite}$(cat /etc/xray/domain)${NC}" 
echo -e "${BICyan} │  ${IBlue}IP-VPS          :  ${BIWhite}$IPVPS${NC}"                  
#echo -e "${BICyan} │  ${IYellow}ISP-VPS         :  ${BIWhite}$ISPVPS${NC}"  
echo -e "${BICyan} │  ${IBlue}Client          :  ${BIWhite}$client_name${NC}"
echo -e "${BICyan} │  ${IBlue}Expired         :  ${BIWhite}$exp_days${NC}"
echo -e "${BICyan} │  ${IBlue}Daily Bandwidth :  ${BIWhite}$daily_usage ${NC}"
echo -e "${BICyan} │  ${IBlue}Total Bandwidth :  ${BIWhite}$monthly_usage ${NC}"
echo -e "${BICyan} └────────────────────────────────────────────────────────────┘${NC}"
echo -e "      ${IYellow}SSH : $ressh ${IYellow} NGINX : $resngx ${IYellow}  XRAY : $resv2r ${IYellow} HAPROXY : $reshpx${NC}"
echo -e "      ${IYellow}DROPBEAR : $resdbr ${IYellow} SSH-WS : $ressshws ${IYellow} Stunnel : $resst${NC}"
echo -e "${BICyan} ┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "    ${BICyan}[${BIRed}01${BICyan}]${BIWhite} SSHWS         ${BIRed}||         ${BICyan}[${BIRed}06${BICyan}]${BIWhite} RESTORE EXPIRED USER${NC}"
echo -e "    ${BICyan}[${BIRed}02${BICyan}]${BIWhite} VMESS         ${BIRed}||         ${BICyan}[${BIRed}07${BICyan}]${BIWhite} USER BANDWIDTH${NC}"
echo -e "    ${BICyan}[${BIRed}03${BICyan}]${BIWhite} VLESS         ${BIRed}||         ${BICyan}[${BIRed}08${BICyan}]${BIWhite} RUNNING STATUS${NC}"
echo -e "    ${BICyan}[${BIRed}04${BICyan}]${BIWhite} TROJAN        ${BIRed}||         ${BICyan}[${BIRed}09${BICyan}]${BIWhite} BACKUP/RESTORE${NC}"
echo -e "    ${BICyan}[${BIRed}05${BICyan}]${BIWhite} SHADOWSOCK    ${BIRed}||         ${BICyan}[${BIRed}10${BICyan}]${BIWhite} FEATURES${NC}"
echo -e "${BICyan} └────────────────────────────────────────────────────────────┘${NC}"
echo -e "      ${IYellow}SSH:${BICyan}[${BIGreen}${ssh}${BICyan}]   ${IYellow}VMESS:${BICyan}[${BIGreen}${vmess}${BICyan}]   ${IYellow}VLESS:${BICyan}[${BIGreen}${vless}${BICyan}]   ${IYellow}TROJAN:${BICyan}[${BIGreen}${tr}${BICyan}]   ${IYellow}SS:${BICyan}[${BIGreen}${ss}${BICyan}]${NC}"
echo -e "${BICyan} ┌────────────────────────────────────────────────────────────┐${NC}"
