...
clear && printf '\033[3J'
echo -e "${BIRed} ╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BIRed} ║                   ${BIWhite}${UWhite}> SYSTEM_INFO_V3 <${NC}                     ${BIRed}║${NC}"
echo -e "${BIRed} ╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}OS Linux    :  ${BIWhite}$(hostnamectl | grep "Operating System" | cut -d ':' -f2 | xargs)${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Kernel      :  ${BIWhite}$(uname -sr)${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}CPU Name    :  ${BIWhite}$cname${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}CPU Info    :  ${BIWhite}$cores Cores @ $freq MHz (${cpu_usage}) ${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Total RAM   :  ${BIWhite}${ram_used}MB / ${total_ram}MB (${ram_usage}%) ${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Uptime      :  ${BIWhite}$uptime${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Domain      :  ${BIWhite}$(cat /etc/xray/domain)${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}IP-VPS      :  ${BIWhite}$IPVPS${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Client      :  ${BIWhite}$client_name ${BIRed}[${BIWhite} Expired: $exp_days ${BIRed}]${NC}"
echo -e "${BIRed} ║  ${BIRed}[>] ${IYellow}Traffic     :  ${BIWhite}Daily: $daily_usage | Total: $monthly_usage ${NC}"
echo -e "${BIRed} ╚══════════════════════════════════════════════════════════╝${NC}"
...
echo -e "${BIRed} ╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BIRed} ║  ${BIRed}[${BIWhite}01${BIRed}]${BIWhite} SSHWS            ${BIRed}[${BIWhite}06${BIRed}]${BIWhite} RESTORE EXPIRED USER         ${BIRed}║${NC}"
echo -e "${BIRed} ║  ${BIRed}[${BIWhite}02${BIRed}]${BIWhite} VMESS            ${BIRed}[${BIWhite}07${BIRed}]${BIWhite} USER BANDWIDTH               ${BIRed}║${NC}"
echo -e "${BIRed} ║  ${BIRed}[${BIWhite}03${BIRed}]${BIWhite} VLESS            ${BIRed}[${BIWhite}08${BIRed}]${BIWhite} RUNNING STATUS               ${BIRed}║${NC}"
echo -e "${BIRed} ║  ${BIRed}[${BIWhite}04${BIRed}]${BIWhite} TROJAN           ${BIRed}[${BIWhite}09${BIRed}]${BIWhite} BACKUP/RESTORE               ${BIRed}║${NC}"
echo -e "${BIRed} ║  ${BIRed}[${BIWhite}05${BIRed}]${BIWhite} SHADOWSOCK       ${BIRed}[${BIWhite}10${BIRed}]${BIWhite} FEATURES                     ${BIRed}║${NC}"
echo -e "${BIRed} ╚══════════════════════════════════════════════════════════╝${NC}"
...
echo -e "${BIRed} ╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BIRed} ║  ${IYellow}Version : ${BIWhite}$sem                            ${BIRed}[${BIWhite}x${BIRed}]${BIWhite} Exit     ${BIRed}║${NC}"
echo -e "${BIRed} ╚══════════════════════════════════════════════════════════╝${NC}"
echo
