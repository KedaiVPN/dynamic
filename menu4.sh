...
echo -e "${BICyan} │"                                                                      
echo -e "${BICyan} │  ${IYellow}OS Linux        :  ${BIWhite}$(hostnamectl | grep "Operating System" | cut -d ' ' -f5-)${NC}"  
echo -e "${BICyan} │  ${IYellow}Kernel          :  ${BIWhite}$(uname -r)${NC}"  
echo -e "${BICyan} │  ${IYellow}CPU Name        :  ${BIWhite}$cname${NC}"
echo -e "${BICyan} │  ${IYellow}CPU Info        :  ${BIWhite}$cores Cores @ $freq MHz (${cpu_usage}) ${NC}"
echo -e "${BICyan} │  ${IYellow}Total RAM       :  ${BIWhite}${ram_used}MB / ${total_ram}MB (${ram_usage}%) ${NC}" 
echo -e "${BICyan} │  ${IYellow}System Uptime   :  ${BIWhite}$uptime${NC}"
echo -e "${BICyan} │  ${IYellow}Current Domain  :  ${BIWhite}$(cat /etc/xray/domain)${NC}" 
echo -e "${BICyan} │  ${IYellow}IP-VPS          :  ${BIWhite}$IPVPS${NC}"                  
#echo -e "${BICyan} │  ${IYellow}ISP-VPS         :  ${BIWhite}$ISPVPS${NC}"  
echo -e "${BICyan} │  ${IYellow}Client          :  ${BIWhite}$client_name${NC}"
echo -e "${BICyan} │  ${IYellow}Expired         :  ${BIWhite}$exp_days${NC}"
echo -e "${BICyan} │  ${IYellow}Daily Bandwidth :  ${BIWhite}$daily_usage ${NC}"
echo -e "${BICyan} │  ${IYellow}Total Bandwidth :  ${BIWhite}$monthly_usage ${NC}"
echo -e "${BICyan} └────────────────────────────────────────────────────────────┘${NC}"
