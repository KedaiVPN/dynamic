...
function trialvless(){
    ...
    vlesslink3="vless://${uuid}@${domain}:443?security=tls&encryption=none&type=grpc&serviceName=vless-grpc&sni=${domain}#VLESS_GRPC_${user}"
...
echo -e "     ${BICyan}[${BIWhite}5${BICyan}] Unlock Account Vless     "
echo -e "     ${BICyan}[${BIWhite}6${BICyan}] Check Detail Account     "
echo -e "     ${BICyan}[${BIWhite}7${BICyan}] Trial Account Vless     "
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
