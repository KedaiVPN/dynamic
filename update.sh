...
# 1.6 Fix script xp.sh agar tidak modifikasi file secara langsung saat loop baca
...
# Mengomentari update-update script selain menu4.sh sesuai permintaan user
