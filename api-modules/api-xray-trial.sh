...
case $protocol in
  ...
  vless)
    ...
    link_grpc="vless://${uuid}@${domain}:443?mode=gun&security=tls&encryption=none&type=grpc&serviceName=vless-grpc&path=vless-grpc&sni=${domain}#${user}"
  ...
  trojan)
    ...
    link_grpc="trojan://${uuid}@${domain}:443?mode=gun&security=tls&type=grpc&serviceName=trojan-grpc&path=trojan-grpc&sni=${domain}#${user}"
